...
} from '../../user-connections/commands/create-user-connection/create-user-connection.command';
import {JwtPayload} from '../../auth/jwt/jwt-auth.strategy';
import {APPLICATION_REPOSITORY, ApplicationRepository,} from '../core/ports/application.repository';
...
export class GithubService {
    ...
    async connectUser(jwtPayload: JwtPayload, gmailPayload: GithubAuthPayload) {
        const application = await this.applicationRepository.findByName(
            'github',
        );
